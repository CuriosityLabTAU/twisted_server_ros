...
xterm -geometry 45x20+300+0 -T "msg_to_game" -e bash -c "python scripts/send_msg_to_game.py $1 $2 $3" &
xterm -geometry 45x20+600+0 -T "Front Camera" -e bash -c "roslaunch cv_camera cv_camera.launch" 
